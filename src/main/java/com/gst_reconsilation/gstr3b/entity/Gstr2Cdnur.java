...
@Entity
@Table(name = "gstr2_cdnur",
        indexes = {
                @Index(name = "idx_gstr2_cdnur_filing", columnList = "filing_id")
        })
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class Gstr2Cdnur {
    ...
    @Column(name = "note_voucher_number", length = 50, nullable = false)
    private String noteVoucherNumber;

    @Column(name = "note_voucher_date")
    private LocalDate noteVoucherDate;
    ...
    @Column(name = "note_voucher_value", precision = 18, scale = 2, nullable = false)
    private BigDecimal noteVoucherValue;
