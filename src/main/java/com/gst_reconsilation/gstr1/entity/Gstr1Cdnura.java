...
@Entity
@Table(name = "gstr1_cdnura",
        indexes = {
                @Index(name = "idx_cdnura_filing", columnList = "filing_id")
        })
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class Gstr1Cdnura {
    ...
    @Column(name = "original_note_number", length = 50, nullable = false)
    private String originalNoteNumber;

    @Column(name = "original_note_date", nullable = false)
    private LocalDate originalNoteDate;

    @Column(name = "revised_note_number", length = 50, nullable = false)
    private String revisedNoteNumber;

    @Column(name = "revised_note_date", nullable = false)
    private LocalDate revisedNoteDate;
